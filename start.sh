...
python prev.py --task music --train_data ./data/Music/train --valid_data ./data/Music/valid --device cpu --input_dim 124 --n_class 11 --n_annotator 44 --epochs 800 --batch_size 128